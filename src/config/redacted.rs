...
pub(crate) struct RedactedConfig {
    ...
    pub(crate) rpc_http_addr: String,
    pub(crate) rpc_auth_token_configured: bool,
...
impl Config {
    pub(crate) fn redacted(&self) -> RedactedConfig {
        RedactedConfig {
            ...
            rpc_http_addr: self.rpc_http_addr.to_string(),
            rpc_auth_token_configured: self.rpc_auth_token.is_some(),
